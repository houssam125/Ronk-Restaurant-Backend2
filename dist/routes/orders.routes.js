...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { user_id, delivery_link, items } = req.body;
    ...
    `;
        ...
        yield (0, websocket_1.broadcastNewOrder)(orderId); // ⬅️ إرسال تفاصيل الطلب
        yield (0, statesRestornt_1.incrementTotalOrders)();
